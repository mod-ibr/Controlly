...
# ------------------ End Function Configuration --------------------------
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(570, 557)
        MainWindow.setMinimumSize(QtCore.QSize(570, 557))
        MainWindow.setMaximumSize(QtCore.QSize(570, 557))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setMinimumSize(QtCore.QSize(570, 516))
        self.centralwidget.setMaximumSize(QtCore.QSize(570, 516))
...
#         self.Stop_Button.setObjectName("Stop_Button")
        ...
        self.Start_Button.setGeometry(QtCore.QRect(110, 480, 121, 31))
...
"")
        ...
        self.Reset_Button.setGeometry(QtCore.QRect(340, 480, 121, 31))
...
"color: rgb(255, 0, 0);")
        ...
        self.HorizontalDivider06.setGeometry(QtCore.QRect(-10, 440, 591, 16))
...
# END  Widget Function Sync ----------------------------------------------
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Controlly"))
